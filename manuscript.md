...
| | (a) vendor's test | (b) published MBTI form | (c) not identifiable |
|---|---|---|---|
| **Works** | 17 | 1 | 9 |
...
Table 5 gives the two measures under the main analysis and each planned arm.
...
That is a statement about instruments, not about attributions, and the two must be kept apart even though the corpus makes them easy to merge. The finding that bears on attribution is the unplanned cross-tabulation: of the 17 works that administered the vendor's test, 15 also called it the MBTI or gave it the MBTI's provenance, and 3 marked the distinction. The first number is the misattribution; the second is the distribution of instruments; a reader who takes the second for the first will overstate this study.
